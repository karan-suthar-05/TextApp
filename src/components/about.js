...
export default function About(props) {
    ...
    props.change("About");
    document.title = "Text-About";
    return (
    <div className='container my-3'  >
        <div className="accordion" id="accordionExample" >
        <div className="accordion-item"  >
            <h2 className="accordion-header" id="headingOne">
            <button className="accordion-button" type="button" style={heading}  data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                Accordion Item #1
            </button>
            </h2>
        ...
        {/* <button className='my-3 btn btn-primary' onClick={darkToggle}>{btnText}</button> */}
    </div>
  )
}
